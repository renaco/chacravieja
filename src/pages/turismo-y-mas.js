...
import banosTermales from "./../images/tourism/banos-termales-san-mateo.jpg"
import banosOromina from "./../images/tourism/banos-oromina.jpg"
  ...
  <Layout>
    ...
    <WrapContent>
      ...
      <WrapContentParagraph>
        <h2 id="morro-de-calzada">MORRO DE CALZADA</h2>
      ...
      <WrapContentParagraph>
        <h2 id="banos-sulfurosos-oromina">BAÑOS SULFUROSOS DE OROMINA</h2>
      ...
      <img src={banosOromina} alt="Baños Termales de Oromina" />

      <img src={embarcaderoPuertoTahuishco} alt="Embarcadero de Tahuishco" />
      <WrapContentParagraph>
        <h2 id="embardadero-de-tahuishco">EMBARCADERO DE TAHUISHCO</h2>
      ...
      <WrapContentParagraph>
        <h2 id="san-mateo">BAÑOS TERMALES DE SAN MATEO</h2>
